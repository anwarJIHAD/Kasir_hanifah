            ...
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    ...
                    <div class="col-auto d-flex w-sm-100">
                        <button type="button" class="btn btn-dark btn-set-task w-sm-100" data-bs-toggle="modal" data-bs-target="#tickadd"><i class="icofont-plus-circle me-2 fs-6"></i>Tambah Barang</button>
                    </div>
                </div>
            </div>
        </div> <!-- Row end  -->
                            ...
                            <tbody>
                                ...
                                <?php foreach ($barang as $us) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('Barang/edit/') . $us['id_barang']; ?>" class="btn bg-lightgreen text-end"><i class="icofont-edit text-success"></i></a>
                                            <a href="<?= base_url('Barang/hapus/') . $us['id_barang']; ?>" class="btn light-danger-bg text-end"><i class="icofont-ui-delete text-danger"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
