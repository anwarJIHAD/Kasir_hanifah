            ...
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    ...
                    <div class="col-auto d-flex w-sm-100">
                        <a class="btn btn-warning btn-set-task w-sm-100" href="<?= base_url('Kembali1') ?>"><i class="icofont-line-block-left me-2 fs-6"></i> back</a>
                    </div>
                </div>
            </div> <!-- Row end  -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($us['tgl_pengembalian'] === null) { ?>
                                                    <a class="btn btn-dark btn-set-task text-end" data-bs-toggle="modal" data-bs-target="#modaltransaksi<?= $us['id_transaksi']; ?>"><i class="icofont-plus-circle me-2 fs-6"></i>Tambahkan Tanggal Kembali</a>
                                                <?php } else { ?>
                                                    transaksi sudah di kembalikan

                                                    <a href="<?= base_url('Kembali1/transaksi2/') . $us['id_transaksi']; ?>" class="btn bg-lightgreen text-end"><i class=" icofont-ui-zoom-in "></i></a>

                                                <?php } ?>
                                                <a href="<?= base_url('Kembali1/export/') . $us['id_transaksi']; ?>" class="btn btn-secondary btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Export</a>
                                            </td>
