            ...
            <div class="border-0 mb-4">
                <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                    ...
                    <div class=" col-auto d-flex w-sm-100">
                        <a class="btn btn-warning btn-set-task w-sm-100" href="<?= base_url('Kembali1/transaksi1/') . $sales['id_sales']; ?>"><i class="icofont-line-block-left me-2 fs-6"></i> back</a>
                ...
                <div class="col-md-12">
                    <div class="card mb-3">
                        ...
                        <div class="card-header py-3  bg-transparent border-bottom-0">
                            ...
                            <h6 class="mb-0 fw-bold ">tanggal transaksi : <?= $sales['nama_sales']; ?></h6>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($transaksi2 as $us) : ?>
                                        <tr>
                                            ...
                                            <td><?= $us['jlh_pinjam'] - $us['jlh_kembali'] ?></td>
                                            <td><?= $us['jlh_kembali'] ?></td>
                                            <td><?= $us['total_harga_pinjam'] ?></td>
                                            <td><?= $us['total_harga_kembali'] ?></td>
                                            <td>
                                                <?php if ($us['jlh_kembali'] === null) { ?>
                                                    <a class="btn btn-dark btn-set-task text-end" data-bs-toggle="modal" data-bs-target="#edit_detail<?= $us['id_detail_transaksi']; ?>"><i class="icofont-plus-circle me-2 fs-6"></i>Kembalikan barang</a>
                                                <?php } else { ?>
